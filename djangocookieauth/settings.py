...
SECRET_KEY = "django-insecure-yn9m%#)g(7570*xapdm3j8_slc=e@jc!0!tn7@p-dmj6@dnsn2"
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR.joinpath('user_frontend/build')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATICFILES_DIRS = (
    BASE_DIR.joinpath('user_frontend/build/static'),
)
